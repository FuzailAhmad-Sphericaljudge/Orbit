...
integration_registry = {
    ...
    IntegrationProvider.monitoring: MonitoringConnector(settings.monitoring_webhook_url, settings.monitoring_webhook_token, settings.prometheus_base_url, settings.prometheus_username, settings.prometheus_bearer_token, settings.integration_timeout_seconds),
}
