...
export const orbitApi = {
  ...
  prepareTool: (incidentId: string, payload: { provider: "monitoring"; operation: "query_snapshot"; risk_level: "low"; payload: { query: string }; rationale: string; idempotency_key: string }) => request<{ id: string }>(`/api/incidents/${incidentId}/tools/prepare`, { method: "POST", body: JSON.stringify(payload) }),
